...
$(document).ready(function() {
	...
	opencpu.seturl("//test.ohmage.org/ocpu/library/dpu.mobility/R")
	...
	function makeDateChart(data){
		...
		mobilityModeGroup = mobilityByMode.group().reduceSum(function(d) { return (d.mode == "walk" | d.mode=="run" | d.mode == "drive") ? d.duration : 0 });		
